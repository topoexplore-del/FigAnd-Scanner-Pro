# 🎓 FigAnd Scanner Pro — Manual del Nivel Profesional

FigAnd incorpora dos mejoras de grado profesional sobre el sistema base: **backtest de rigor institucional** y **conciencia de eventos (earnings)**. Este manual explica qué cambió, cómo leerlo y cómo configurarlo.
